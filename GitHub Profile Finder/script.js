  ...
  fetch(`https://api.github.com/users/${user_name}`)
    ...
    .then((jsonData) => {
      if (jsonData.message == "Not found") {
        ...
        userImg.innerHTML = `
			<a href="${jsonData.html_url}" id="username" target=”_blank”><img src="${jsonData.avatar_url}" alt="avatar" id="prof-img"></a>
            <a href="${jsonData.html_url}" id="username" target=”_blank”><span class="name" id="name">${jsonData.name}</span></a>
